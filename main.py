...
# Normalize Render's URL to psycopg v3
...
DATABASE_URL = os.environ["DATABASE_URL"]  # e.g. postgresql+psycopg://USER:PASSWORD@HOST:PORT/DB
engine = create_engine(DATABASE_URL, pool_pre_ping=True, future=True)
...
def get_scatter_chart():
    try:
        ...
        # NOTE: Columns are "Date" and "Time" in DB
